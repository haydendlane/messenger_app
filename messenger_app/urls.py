...
'''
Django project app - Use for admin and account functionality
    ...
    * path('pasword-reset-confirm/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='users/password_reset_confirm.html'), name='password-reset-confirm')
    ...
    * path('', include('messenger.urls'))', pass request to messenger urls.py
...
urlpatterns = [
    ...
    path('api/delivery/', messenger_views.delivery, name='api'),
    path('privacy/', messenger_views.privacy_policy, name='privacy-policy'),
]

handler500 = 'messenger.views.handler500'